...
public class SecStrConsensus {
  ...
  private static ArrayList<SimpleBP> backtrack(
      double[][] tab, ArrayList<Hashtable<Integer, Double>> seq) {
    return backtrack(tab, seq, 0, seq.size() - 1);
  }

  private static ArrayList<SimpleBP> backtrack(
      double[][] tab, ArrayList<Hashtable<Integer, Double>> seq, int i, int j) {
