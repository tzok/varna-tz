...
public class SuperpositionDemo extends JFrame implements InterfaceVARNAListener {
        ...
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            try {
              ...
              Mapping m =
                  Mapping.readMappingFromAlignment(
  ...
  public String getStruct(int i) {
    if (i == 0) return _struct1.getText();
    else return _struct2.getText();
  }
  ...
  public void onStructureRedrawn() {
    try {
      ...
      ControleurInterpolator.moveNearOtherRNA(
          getRNA((_currentDisplay) % 2), getRNA((_currentDisplay + 1) % 2), m);
      _vpSlave.repaint();
      _vpMaster.repaint();
    } catch (MappingException e3) {
