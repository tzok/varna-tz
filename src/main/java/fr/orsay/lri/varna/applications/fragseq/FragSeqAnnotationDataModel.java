...
public class FragSeqAnnotationDataModel extends FragSeqModel {
  ...
  public static void addRandomAnnotations(RNA r, FragSeqAnnotationDataModel data) {
    ...
    Color[] colors = {
      Color.orange, Color.black, Color.blue.darker(), Color.green.darker(), Color.gray
    };
  ...
  public static DataFlavor Flavor =
      new DataFlavor(FragSeqAnnotationDataModel.class, "RNA Chem Prob Data");
}
