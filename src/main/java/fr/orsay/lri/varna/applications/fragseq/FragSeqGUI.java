...
public class FragSeqGUI extends JFrame
  ...
  private void RNAPanelDemoInit() {
                  ...
                  public Object getTransferData(DataFlavor df)
                    ...
                    DefaultMutableTreeNode node =
                        (DefaultMutableTreeNode)
                            _sideList.getSelectionPath().getLastPathComponent();
    ...
    _splitVARNA =
        new JSplitPane(
            JSplitPane.VERTICAL_SPLIT, redrawOnSlide, _varnaUpperPanels, _varnaLowerPanels);
    ...
    _splitRight =
        new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, redrawOnSlide, _splitLeft, _infoPanel);
  ...
  public void removeUpperPanel() {
    if (_varnaUpperPanels.getComponentCount() > 1) {
      VARNAHolder vh =
          (VARNAHolder) _varnaUpperPanels.getComponent(_varnaUpperPanels.getComponentCount() - 1);
        ...
        if (t != null) {
          ...
          if (node.getUserObject() instanceof FragSeqFileModel) {
            ...
            if (model instanceof FragSeqRNASecStrModel) {
              res =
                  index
                      % (_varnaUpperPanels.getComponentCount()
                          + _varnaLowerPanels.getComponentCount());
            } else {
              res =
                  (index
                          + _varnaUpperPanels.getComponentCount()
    ...
    if (cmd.equals("" + Commands.NEW_FOLDER)) {
      ...
      try {
        ...
        UIManager.setLookAndFeel(
            ((LookAndFeelInfo) _lnf.getModel().getSelectedItem()).getClassName());
