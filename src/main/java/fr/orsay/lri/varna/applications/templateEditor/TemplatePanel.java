...
public class TemplatePanel extends JPanel {
  ...
  private Hashtable<
          Couple<GraphicalTemplateElement, GraphicalTemplateElement.RelativePosition>, Connection>
      _helixToConnection;
  ...
  private static Color[] BackgroundColors = {
    Color.blue, Color.red, Color.cyan, Color.green, Color.lightGray, Color.magenta, Color.PINK
  };
  ...
  private void init() {
    ...
    _helixToConnection =
        new Hashtable<
            Couple<GraphicalTemplateElement, GraphicalTemplateElement.RelativePosition>,
            Connection>();
    ...
    _dashedStroke =
        new BasicStroke(1.5f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND, 3.0f, dash, 0);
  }
  ...
  public GraphicalTemplateElement getElement(RNATemplateElement t) {
    for (GraphicalTemplateElement t2 : _RNAComponents) if (t == t2.getTemplateElement()) return t2;
    return null;
  }
  ...
  public GraphicalTemplateElement getElementAt(
      double x, double y, GraphicalTemplateElement excluded) {
    GraphicalTemplateElement h = null;
    for (int i = 0; i < _RNAComponents.size(); i++) {
      GraphicalTemplateElement h2 = _RNAComponents.get(i);
      if (((h2.getRelativePosition(x, y) == Helix.RelativePosition.RP_CONNECT_END3)
  ...
  public GraphicalTemplateElement getElementCloseTo(
      double x, double y, GraphicalTemplateElement excluded) {
    GraphicalTemplateElement h = null;
    for (int i = 0; i < _RNAComponents.size(); i++) {
      GraphicalTemplateElement h2 = _RNAComponents.get(i);
      if ((h2.getRelativePosition(x, y) != Helix.RelativePosition.RP_OUTER) && (excluded != h2)) {
        h = h2;
      }
    }
    return h;
  ...
  public void addConnection(Connection c) {
    ...
    _helixToConnection.put(
        new Couple<GraphicalTemplateElement, GraphicalTemplateElement.RelativePosition>(
            c._h1, c._edge1),
        c);
    _helixToConnection.put(
        new Couple<GraphicalTemplateElement, GraphicalTemplateElement.RelativePosition>(
  ...
  public Connection addConnection(
      GraphicalTemplateElement h1,
      GraphicalTemplateElement.RelativePosition edge1,
      GraphicalTemplateElement h2,
      GraphicalTemplateElement.RelativePosition edge2) {
  ...
  /**
   * When there is already a connection in the underlying RNATemplate and we want to create one at
   * the graphical level.
   */
  public void addGraphicalConnection(
      GraphicalTemplateElement h1,
      GraphicalTemplateElement.RelativePosition edge1,
      GraphicalTemplateElement h2,
      GraphicalTemplateElement.RelativePosition edge2) {
  ...
  public boolean isInCycle(
      GraphicalTemplateElement el, GraphicalTemplateElement.RelativePosition edge) {
    Stack<Couple<GraphicalTemplateElement, GraphicalTemplateElement.RelativePosition>> p =
        new Stack<Couple<GraphicalTemplateElement, GraphicalTemplateElement.RelativePosition>>();
    Hashtable<Couple<GraphicalTemplateElement, GraphicalTemplateElement.RelativePosition>, Integer>
        alreadySeen =
            new Hashtable<
                Couple<GraphicalTemplateElement, GraphicalTemplateElement.RelativePosition>,
                Integer>();
    p.add(
        new Couple<GraphicalTemplateElement, GraphicalTemplateElement.RelativePosition>(el, edge));
    while (!p.empty()) {
      ...
      Couple<GraphicalTemplateElement, GraphicalTemplateElement.RelativePosition> otherEnd =
          new Couple<GraphicalTemplateElement, GraphicalTemplateElement.RelativePosition>(
              c2.first, next);
      if (!alreadySeen.containsKey(otherEnd)) {
        p.push(otherEnd);
      } else {
        Couple<GraphicalTemplateElement, GraphicalTemplateElement.RelativePosition> child =
            getPartner(c2.first, c2.second);
        if (child != null) {
          p.push(child);
        }
      }
  ...
  private static Color[] _colors = {
    Color.gray, Color.pink, Color.cyan, Color.RED, Color.green, Color.orange
  };
  ...
  public HashMap<
          Couple<GraphicalTemplateElement, GraphicalTemplateElement.RelativePosition>, Integer>
      buildConnectedComponents() {
    HashMap<Couple<GraphicalTemplateElement, GraphicalTemplateElement.RelativePosition>, Integer>
        alreadySeen =
            new HashMap<
                Couple<GraphicalTemplateElement, GraphicalTemplateElement.RelativePosition>,
                Integer>();
    ...
    for (GraphicalTemplateElement el : this._RNAComponents) {
      for (GraphicalTemplateElement.RelativePosition edge : el.getConnectedEdges()) {
        Couple<GraphicalTemplateElement, GraphicalTemplateElement.RelativePosition> c =
            new Couple<GraphicalTemplateElement, GraphicalTemplateElement.RelativePosition>(
                el, edge);
        if (!alreadySeen.containsKey(c)) {
          ...
          p.add(
              new Couple<GraphicalTemplateElement, GraphicalTemplateElement.RelativePosition>(
                  el, el.getConnectedEdge(edge)));
          while (!p.empty()) {
            Couple<GraphicalTemplateElement, GraphicalTemplateElement.RelativePosition> c2 =
                p.pop();
            if (!alreadySeen.containsKey(c2)) {
  ...
  public Couple<GraphicalTemplateElement, GraphicalTemplateElement.RelativePosition> getPartner(
      GraphicalTemplateElement h, GraphicalTemplateElement.RelativePosition edge) {
    Connection c = getConnection(h, edge);
    if (c != null) {
      if ((c._h1 == h) && (c._edge1 == edge)) {
        return new Couple<GraphicalTemplateElement, GraphicalTemplateElement.RelativePosition>(
            c._h2, c._edge2);
      } else {
        return new Couple<GraphicalTemplateElement, GraphicalTemplateElement.RelativePosition>(
            c._h1, c._edge1);
  ...
  public Connection getConnection(GraphicalTemplateElement h, Helix.RelativePosition edge) {
    Couple<GraphicalTemplateElement, GraphicalTemplateElement.RelativePosition> target =
        new Couple<GraphicalTemplateElement, GraphicalTemplateElement.RelativePosition>(h, edge);
  ...
  private boolean isConnected(Helix h, GraphicalTemplateElement.RelativePosition edge) {
    Couple<GraphicalTemplateElement, GraphicalTemplateElement.RelativePosition> partner =
        getPartner(h, edge);
    return partner != null;
  }
  ...
  public void loadTemplate(RNATemplate template) {
    ...
    Map<RNATemplateElement, GraphicalTemplateElement> map =
        new HashMap<RNATemplateElement, GraphicalTemplateElement>();
      ...
      while (iter.hasNext()) {
        ...
        if (templateElement instanceof RNATemplateHelix) {
          ...
          RNATemplateUnpairedSequence templateSequence =
              (RNATemplateUnpairedSequence) templateElement;
  ...
  public void loadFromXmlFile(File filename) {
    try {
      ...
      JOptionPane.showMessageDialog(
          this, e.getMessage(), "Template loading error", JOptionPane.ERROR_MESSAGE);
    }
  }
