...
public class ControleurSelectionHighlight implements ChangeListener {
  ...
  public ControleurSelectionHighlight(Vector<Integer> sel, VARNAPanel v, JMenuItem parent) {
    this(new ArrayList<Integer>(sel), v, parent);
  }

  public ControleurSelectionHighlight(ArrayList<Integer> sel, VARNAPanel v, JMenuItem parent) {
    this(v.getRNA().getBasesAt(sel), v, parent);
  }

  public ControleurSelectionHighlight(
      Collection<? extends ModeleBase> sel, VARNAPanel v, JMenuItem parent) {
    _selection = sel;
    _target = v;
    _parent = parent;
  }
