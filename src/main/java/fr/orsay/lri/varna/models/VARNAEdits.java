...
public class VARNAEdits {
  ...
  public static class BasesShiftEdit extends AbstractUndoableEdit {
    ...
    public void undo() throws CannotUndoException {
      for (int index : _indices) {
        ...
        _vp.getRNA()
            .setCoord(index, new Point2D.Double(mb.getCoords().x - _dx, mb.getCoords().y - _dy));
        _vp.getRNA()
            .setCenter(index, new Point2D.Double(mb.getCenter().x - _dx, mb.getCenter().y - _dy));
      }
      _vp.repaint();
    }
  ...
  public static class HelixRotateEdit extends AbstractUndoableEdit {
    ...
    public HelixRotateEdit(
        double delta, double base, double pLimL, double pLimR, Point h, Point ml, VARNAPanel vp) {
      _delta = delta;
      _base = base;
      _pLimL = pLimL;
      _pLimR = pLimR;
    ...
    public String getPresentationName() {
      return "Helix #" + _h + " rotated angle:" + _delta;
    }
  ...
  public static class RescaleRNAEdit extends AbstractUndoableEdit {
    ...
    public String getPresentationName() {
      return "Rescale RNA factor:" + _factor + "";
    }
  ...
  public static class RotateRNAEdit extends AbstractUndoableEdit {
    ...
    public String getPresentationName() {
      return "Rotate RNA angle:" + _angle + "";
    }
