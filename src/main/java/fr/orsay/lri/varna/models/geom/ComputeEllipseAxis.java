...
public class ComputeEllipseAxis {
  ...
  /**
   * Given one axis half-length b and the circumference l, find the other axis half-length a.
   * Returns 0 if there is no solution. Implemented with Newton's method.
   */
