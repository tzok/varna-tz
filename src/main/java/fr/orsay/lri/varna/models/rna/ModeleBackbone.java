...
public class ModeleBackbone implements Serializable {
  ...
  /** */
  private Hashtable<Integer, ModeleBackboneElement> elems =
      new Hashtable<Integer, ModeleBackboneElement>();
  ...
  public BackboneType getTypeAfter(int indexBase) {
    if (elems.containsKey(indexBase)) return elems.get(indexBase).getType();
    else return BackboneType.SOLID_TYPE;
  }
