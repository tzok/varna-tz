...
public abstract class ModeleBase implements Serializable, java.lang.Comparable<ModeleBase> {
   ...
   *
   * @param base - This InterfaceBase new style.
   */
   ...
   *
   * @param _colorie - TRUE if you want this InterfaceBase to be colored, else FALSE
   */
  ...
  public int getElementStructure() {
    if (_BP == null) return -1;
    else {
      if (_BP.getPartner5() == this) return _BP.getPartner3().getIndex();
      else return _BP.getPartner5().getIndex();
    }
  }
   ...
   *
   * @param structure - This new assiocated structure element.
   *     <p>public void setElementStructure(int structure) { setElementStructure(structure, new
   *     ModeleBP()); }
   */
   ...
   *
   * @param structure - This new associated structure element.
   * @param type - The type of this base pair.
   */
   ...
   *
   * @param type - The new base pair type for this element.
   */
