...
/**
 * <b>The RNA base comparison model</b>. In each bases we'll place <b>two characters</b>
 * representing nitrogenous bases of both RNA that have to be compared. So, in each base in the
 * comparison model, we'll have a <b>couple of bases</b>, with the same coordinates on the final
 * drawing.
 *
 * @author Masson
 */
public class ModeleBasesComparison extends ModeleBase {
  ...
  /**
   * This ModeleBasesComparison owning statement. It's value will be 0 if this base is common for
   * both RNA that had been compared, 1 if this base is related to the first RNA, 2 if related to
   * the second. Default is -1.
   */
  ...
  /**
   * Creates a new comparison base at the specified coordinates, with the default display style and
   * no nitrogenous bases.
   *
   * @param coords - The coordinates in which the comparison base has to be placed.
   */
   ...
   *
   * @param base1 - The first RNA' nitrogenous base
   * @param base2 - The second RNA' nitrogenous base
   */
  ...
  /**
   * Creates a new comparison base with the specified nitrogenous bases, at the specified
   * coordinates.
   *
   * @param base1 - The first RNA' nitrogenous base
   * @param base2 - The second RNA' nitrogenous base
   ...
   * Creates a new comparison base with the specified nitrogenous bases.
   *
   * @param coords - This base's XY coordinates
   * @param base1 - The first RNA' nitrogenous base
   * @param base2 - The second RNA' nitrogenous base
   * @param colorie - Whether or not this base will be drawn
   * @param mb - The drawing style for this base
   * @param elementStructure - The index of a bp partner in the secondary structure
   * @param index - Index of this base in its initial sequence
   */
  public ModeleBasesComparison(
      Point2D coords,
      char base1,
      char base2,
      boolean colorie,
   ...
   *
   * @param colored - TRUE if this comparison base has to be colored, else FALSE.
   */
   ...
   *
   * @param _base1 - The base of the first RNA in this comparison base.
   */
   ...
   *
   * @param _base2 - The base of the second RNA in this comparison base.
   */
   ...
   *
   * @param _appartenance : 0 if this base is common for both RNA<br>
   *     1 if this base is related to the first RNA<br>
   *     2 if this base is related to the second RNA.
   */
