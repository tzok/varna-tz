...
/**
 * The type of node values in an alignment. Contains a reference to both original nodes. This class
 * implements GraphvizDrawableNodeValue but it will only work if the original nodes implement it.
 *
...
public class AlignedNode<OriginalNodeValueType1, OriginalNodeValueType2>
  ...
  /**
   * This method will work only if the left and right node already implement
   * GraphvizDrawableNodeValue.
   */
  @SuppressWarnings("unchecked")
  public String toGraphvizNodeName() {
    return "("
        + maybeNodeToGraphvizNodeName((Tree) leftNode)
        + ","
