...
/**
 * In this model, nodes are either: 1. a couple of paired bases, and in that case they may have
 * children, in this case singleNode is true 2. a single base that comes from a broken base pair
 * (broken during planarization), without children, in this case singleNode is true 3. a list of
 * consecutive non-paired bases, without children. in this case singleNode is false Note that case 2
 * happens only if original sequences contained pseudoknots, otherwise this case can be ignored.
 *
...
public class RNANodeValue2 implements GraphvizDrawableNodeValue {
  ...
  /**
   * In case of a single node, return it. Will throw RNANodeValue2WrongTypeException if singleNode =
   * false.
   */
  ...
  /**
   * In case of multiple nodes, return them. Will throw RNANodeValue2WrongTypeException if
   * singleNode = true.
   */
