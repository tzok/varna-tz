...
/**
 * This class contains all functions that are specific to trees (class Tree) of RNA, with
 * RNANodeValue2.
 *
...
public class RNATree2 {
  ...
  /**
   * Convert from RNANodeValue model to RNANodeValue2 model, ie. compact consecutive non-paired
   * bases.
   */
  ...
  private static void RNAForest2FromRNAForestCommitNonPaired(
      List<Tree<RNANodeValue2>> forest, List<RNANodeValue> consecutiveNonPairedBases) {
  ...
  private static List<Tree<RNANodeValue2>> RNAForest2FromRNAForest(
      List<Tree<RNANodeValue>> originalForest) throws RNATree2Exception {
  ...
  public static Mapping mappingFromAlignment(
      Tree<AlignedNode<RNANodeValue2, RNANodeValue2>> alignment) throws MappingException {
  ...
  private static class ConvertToMapping {
    ...
    public Mapping convert(Tree<AlignedNode<RNANodeValue2, RNANodeValue2>> tree)
    ...
    private void convertSubTree(Tree<AlignedNode<RNANodeValue2, RNANodeValue2>> tree)
        throws MappingException {
