...
public class TreeGraphviz {
  ...
  public static void treeToGraphvizPostscript(
      Tree<? extends GraphvizDrawableNodeValue> tree, String filename, String title)
      throws IOException {
  ...
  public static void treeToGraphvizPostscript(
      Tree<? extends GraphvizDrawableNodeValue> tree, String filename) throws IOException {
   ...
   */
  public static void treeToGraphvizFile(
      Tree<? extends GraphvizDrawableNodeValue> tree, String filename, String title)
      throws IOException {
    BufferedWriter bw;
   ...
   * @param title the title of the graph
   */
  public static String treeToGraphviz(
      Tree<? extends GraphvizDrawableNodeValue> tree, String title) {
