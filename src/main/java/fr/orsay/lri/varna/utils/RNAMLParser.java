...
public class RNAMLParser extends DefaultHandler {
  ...
  public class BPTemp {
    ...
    public ModeleBP createBPStyle(ModeleBase mb5, ModeleBase mb3) {
      ...
      if ((edge5.equals("+") && edge3.equals("+")) || (edge5.equals("-") && edge3.equals("-"))) {
        e3 = ModeleBP.Edge.WC;
        e5 = ModeleBP.Edge.WC;
      }
    ...
    public String toString() {
      return ("[" + pos5 + "," + pos3 + "," + edge5 + "," + edge3 + "," + orientation + "]");
    }
  }
  ...
  public void endElement(String uri, String localName, String qName) throws SAXException {
    if (qName.equals("numbering-table")) {
      ...
      for (int i = 0; i < tokens.length; i++) {
        for (int j = 0; j < tokens[i].length(); j++) results.add("" + tokens[i].charAt(j));
      }
  ...
  public static void planarize(
      ArrayList<ModeleBP> input,
      ArrayList<ModeleBP> planar,
      ArrayList<ModeleBP> others,
      int length) {
    // System.err.println("Planarize: Length:"+length);
    Hashtable<Integer, ArrayList<ModeleBP>> index2BPs =
        new Hashtable<Integer, ArrayList<ModeleBP>>();
  ...
  private void postProcess() {
    for (RNATmp r : _molecules.values()) {
      ...
      Hashtable<Integer, Hashtable<Integer, BPTemp>> index2BPs =
          new Hashtable<Integer, Hashtable<Integer, BPTemp>>();
