...
public class VueAboutPanel extends JPanel {
  ...
  private void init() {
    try {
      ...
      _textPanel.setBorder(BorderFactory.createMatteBorder(0, 15, 0, 15, getBackground()));
      ...
      _anim.addRNA("GGGGAAGGGGAAAACCCCAACCCC", "((((..((((....))))..))))");
      ...
      _anim.addRNA(
          "GGGGAGGGGAAAACCCCAGGGGAAAACCCCAGGGGAAAACCCCACCCC",
          "((((.((((....)))).((((....)))).((((....)))).))))");
      _anim.addRNA(
