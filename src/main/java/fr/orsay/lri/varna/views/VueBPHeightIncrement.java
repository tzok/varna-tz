  ...
  public VueBPHeightIncrement(VARNAPanel vp) {
    ...
    spaceSlider =
        new JSlider(
            ...
            10,
            200,
            Integer.valueOf(String.valueOf(Math.round(vp.getRNA().getBPHeightIncrement() * 100))));
    // Turn on labels at major tick marks.
    spaceSlider.setMajorTickSpacing(30);
    spaceSlider.setPaintTicks(true);
    spaceSlider.setPaintLabels(true);

    JLabel spaceLabel = new JLabel(String.valueOf(vp.getRNA().getBPHeightIncrement() * 100.0));
    spaceLabel.setPreferredSize(new Dimension(50, spaceLabel.getPreferredSize().height));
    spaceSlider.addChangeListener(new ControleurSliderLabel(spaceLabel, false));
