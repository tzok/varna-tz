...
public class VueChemProbAnnotation implements ChangeListener, ActionListener, ItemListener {
  ...
  public boolean show() {
    ...
    if (JOptionPane.showConfirmDialog(
            _vp,
            getPanel(),
            "Edit chemical probing annotation",
  ...
  public void itemStateChanged(ItemEvent e) {
    if (e.getSource() == outward) {
      ...
      _vp.repaint();
        ...
        && (e.getItem() instanceof ChemProbAnnotation.ChemProbAnnotationType)) {
      ChemProbAnnotation.ChemProbAnnotationType t =
          (ChemProbAnnotation.ChemProbAnnotationType) e.getItem();
      _an.setType(t);
      _vp.repaint();
    }
  }
