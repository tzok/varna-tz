...
public class VueGlobalRescale {
  ...
  public VueGlobalRescale(VARNAPanel vp) {
    ...
    rescaleLabel.setPreferredSize(new Dimension(50, rescaleLabel.getPreferredSize().height));
    rescaleSlider.addChangeListener(new ControleurSliderLabel(rescaleLabel, false));
