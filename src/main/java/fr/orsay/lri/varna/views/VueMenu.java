...
public class VueMenu extends JPopupMenu {
  ...
  private JCheckBoxMenuItem _itemOptionSpecialBaseColored =
      new JCheckBoxMenuItem("Custom colored", false);
  ...
  private JCheckBoxMenuItem _itemOptionBondsColored =
      new JCheckBoxMenuItem("Use base color for base-pairs", false);
  ...
  private JCheckBoxMenuItem _itemFlatExteriorLoop =
      new JCheckBoxMenuItem("Flat exterior loop", false);
  ...
  private void addTitle(String title, boolean keep) {
    ...
    Font futureFont =
        previousFont.deriveFont(Font.BOLD).deriveFont((float) previousFont.getSize() + 1.0f);
  ...
  private void configMenuItem(
      JMenuItem mi, String command, String keyStroke, Container par, boolean disabled) {
  ...
  private JMenuItem createMenuItem(
      String caption, String command, String keyStroke, Container par, boolean disabled) {
  ...
  private JMenuItem createMenuItem(
      String caption, String command, String keyStroke, Container par) {
  ...
  private void annotationMenu() {
    ...
    createMenuItem(
        "Auto interior loops", "annotationsautointerior", "alt shift Q", submenuAnnotations);
    createMenuItem(
        "Auto terminal loops", "annotationsautoterminal", "control shift Q", submenuAnnotations);
  ...
  private void displayMenu() {
    ...
    configMenuItem(
        _itemOptionSpecialBaseColored, "specialbasecolored", "control J", subMenuNSBases);
    ...
    _dashBasesColor =
        createMenuItem("Color", "dashBasesColor", "control shift D", subMenuGapsBases);
    // Removable separator
    JSeparator sep = new JSeparator();
    _disabled.add(sep);
    ...
    configMenuItem(
        _itemShowColorMap, "toggleshowcolormap", "control shift L", submenuColorMap, false);
    ...
    createMenuItem(
        "Load values...", "colormaploadvalues", "control shift K", submenuColorMap, true);
  ...
  private void redrawMenu() {
    ...
    _bpHeightIncrement =
        createMenuItem("BP height increment", "bpheightincrement", "control H", submenuRedraw);
    ...
    createMenuItem(
        "Space between bases", "spaceBetweenBases", "control shift S", submenuRedraw, true);
  ...
  public void addAnnotationMenu(JMenu menu, boolean existingAnnot) {
    ...
    if (existingAnnot) {
      ...
      else debut = texte.substring(0, 5) + "...";
    ...
    createMenuItem(
        "Remove", menu.getActionCommand() + "annotationremove", "", menuAnnotation, true);
