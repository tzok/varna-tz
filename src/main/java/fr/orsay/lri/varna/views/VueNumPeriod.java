...
public class VueNumPeriod {
  ...
  public VueNumPeriod(VARNAPanel vp) {
    ...
    numPeriodSlider =
        new JSlider(JSlider.HORIZONTAL, 1, maxPeriod, Math.min(_vp.getNumPeriod(), maxPeriod));
    ...
    numLabel.setPreferredSize(new Dimension(50, numLabel.getPreferredSize().height));
    numPeriodSlider.addChangeListener(new ControleurSliderLabel(numLabel, false));
